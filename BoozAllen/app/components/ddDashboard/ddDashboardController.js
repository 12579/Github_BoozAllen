...
(function () {
    ...
    .controller('DdDashboardCtrl', ["$state", "$scope", "$stateParams", "$window", "$http", "authenticationSvc", "ShareData", function ($state, $scope, $stateParams, $window, $http, authenticationSvc, shareData) {
        ...
        var casecolumnDefs = [
            ...
            },
            {
                ...
                width: 700,
                cellRenderer: riskDnaHandler, filter: 'number',
