 ...
 $scope.reviewcaseSummary = true;
               ...
               $scope.decisioncaseSummary = true;
                ...
                var relatedCasesAndAlertsColumnDefs = [
                    ...
                    {
                        headerName: "User Details", field: "", width: 300, suppressMenu: 'true', cellClass: 'rag-entity', cellRenderer: function (params) {
                ...
                var alertedTransactionsColumnDefs = [
                  ...
                  {
                      headerName: "", field: "accountHolderName", width: 95, suppressMenu: 'true', cellRenderer: upperCaseNewValueHandler,
                      cellClass: 'rag-initial',
                      cellClassRules: {
                  ...
                  {
                      headerName: "Account Holder Details", field: "", width: 300, suppressMenu: 'true', cellClass: 'rag-entity', cellRenderer: function (params) {
                     ...
                     {
                         headerName: "", field: "beneficiaryName", width: 95, suppressMenu: 'true', cellRenderer: upperCaseNewValueHandler,
                         cellClass: 'rag-initial',
                         cellClassRules: {
                    ...
                    {
                        headerName: "Beneficiary Details", field: "", width: 300, suppressMenu: 'true', cellClass: 'rag-entity', cellRenderer: function (params) {
        ...
        $scope.selectedCaseStatus = $scope.caseDetailgridOptions.caseStatus;
                ...
                $scope.ExportToExcel = function () {
                    ...
                    var alertedTransactionsOptionsForExport = angular.copy($scope.alertedTransactionsOptions.rowData);

                    for (var i = 0; i < alertedTransactionsOptionsForExport.length; i++) {

                        delete alertedTransactionsOptionsForExport[i].accountHolderRiskScore;
                        delete alertedTransactionsOptionsForExport[i].beneficiaryRiskScore;                        
                    }

                    alasql('SELECT * INTO XLSX("report.xlsx",{headers:true}) FROM ?', [alertedTransactionsOptionsForExport]);
                };
