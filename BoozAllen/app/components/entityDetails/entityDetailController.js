        ...
        .controller('entityDetailCtrl', [
            ...
            function ($state, $scope, $stateParams, $window, $http, authenticationSvc, shareData, visDataSet, globals) {
                ...
                $scope.cardNext = function () {
                    ...
                    var currentIndex = angular.element(current).index() + 1;
                    for (var i = currentIndex; i < noOtItems; i++) {
                ...
                $scope.openAddPopup = function (event, type) {
                    angular.element('.addPopup[data-type=' + type + ']').fadeIn();
                ...
                $scope.NegativeNewsDataPopup = function (title) {
                    ...
                    for (var i = 0; i < notesGridArray.length; i++) {
                        ...
                        if (title === idVal) {
                            ...
                            jQuery("#negativeNewsRiskUrl").html('Source: <a href="' + record.url + '" target="new">' + record.url + '</a>');
                ...
                function isValidateHandler(params) {
                    ...
                    if (isValid) {
                        rtnVal = '<span style="display: inline-block"><div class="switch"><input id="cmn-toggle-' + params.data.documentId + '" class="cmn-toggle cmn-toggle-round" type="checkbox" ng-click="onDocValidationChange(' + paramVal + ')" checked><label for="cmn-toggle-' + params.data.documentId + '"><span>OFF</span></label></div></span>';
                    } else {
                        rtnVal = '<span style="display: inline-block"><div class="switch"><input id="cmn-toggle-' + params.data.documentId + '" class="cmn-toggle cmn-toggle-round" type="checkbox" ng-click="onDocValidationChange(' + paramVal + ')" ><label for="cmn-toggle-' + params.data.documentId + '"><span>OFF</span></label></div></span>';
                    }
                    // + '</span>';
                    return rtnVal;
                }
                ...
                $scope.hidePopoverGene = function (index, event, type) {
                    if (angular.element(event.currentTarget).closest('li').hasClass('active')) {

                        switch (type) {
                            case "ATTRIBUTE":
                                var attributeRiskGridRows = angular.element('.attributeRiskGrid .tabRow > div');
                                angular.element(attributeRiskGridRows[index]).css('border', '');
                                this.popoverIsVisibleGene = false;
                                break;

                            case "WATCHLIST":
                                var watchlistGridRows = angular.element('.watchlistGridRow');
                                angular.element(watchlistGridRows[index]).css('border', '');
                                this.popoverIsVisibleGene = false;
                                break;

                            case "NEGATIVENEWS":
                                var dnaItem = event.currentTarget;
                                angular.element('.negativeGridRowId').css('border', '');
                                this.popoverIsVisibleGene = false;
                                break;
                            ...
                            case "ACCOUNT":
                                angular.element('.accountGridRow').css('border', '');
                                this.popoverIsVisibleGene = false;
                                break;

                            case "TRANSACTION":
                                var dnaItem = event.currentTarget;
                                angular.element('.activityGridRowId').css('border', '');
                                this.popoverIsVisibleGene = false;
                                break;
                        }
                    }
                ...
                $scope.showPopoverGene = function (index, event, type) {
                    if (angular.element(event.currentTarget).closest('li').hasClass('active')) {
                        var borderColor;
                        switch (type) {
                            case "ATTRIBUTE":
                                var elem = event.currentTarget;
                                borderColor = angular.element(elem).css('background-color');
                                var rows = angular.element('.attributeRiskGrid .tabRow > div');
                            ...
                            case "WATCHLIST":
                                var gridRows = angular.element('.watchlistGridRow');
                                var dnaItem = event.currentTarget;
                                borderColor = angular.element(dnaItem).css('background-color');
                                angular.element(gridRows[index]).css('border', '2px solid ' + borderColor);
                                this.popoverIsVisibleGene = true;
                                break;
                            ...
                            case "NEGATIVENEWS":
                                var dnaItem = event.currentTarget;
                                borderColor = angular.element(dnaItem).css('background-color');
                                angular.element('.negativeGridRowId' + index).css('border', '2px solid ' + borderColor);
                                this.popoverIsVisibleGene = true;
                                break;
                            ...
                            case "ACCOUNT":
                                var gridRows = angular.element('.accountGridRow');
                                var dnaItem = event.currentTarget;
                                borderColor = angular.element(dnaItem).css('background-color');
                                angular.element(gridRows[index]).css('border', '2px solid ' + borderColor);
                                this.popoverIsVisibleGene = true;
                            ...
                            case "TRANSACTION":
                                index = index - 2;
                                var gridRows = angular.element('.activityGridRowId');
                                var dnaItem = event.currentTarget;
                                borderColor = angular.element(dnaItem).css('background-color');
                                angular.element('.activityGridRowId' + index).css('border', '2px solid ' + borderColor);
                                this.popoverIsVisibleGene = true;
                                break;
                        }
                    }
                ...
                $scope.toggle = function (active, new1, email, span) {
                    ...
                    if (new1) {
                        $scope.newcardcount = $scope.newcardcount - 1;
                        data = $scope.cardDatas;
                        for (i = 0; i < data.length; i++) {
                            if (data[i].email === email) {
                                data[i].new = !data[i].new;
                                data[i].active = span === 'on';

                                $scope.dataObject.person.personas[i].isNew = data[i].new;
                                $scope.dataObject.person.personas[i].isActive = data[i].active;
                            }
                        }
                ...
                $scope.changeLogGridOptions = {
                    ...
                    rowHeight: 60 * globals.defaultVars.w / globals.defaultVars.winRef, //0.0416 * angular.element(window).width(),           
                    enableSorting: true,
                ...
                var accountGridColumnDefs = [
                    ...
                    },
                    {
                        headerName: "",
                        field: "",
                        width: 170 * globals.defaultVars.w / globals.defaultVars.winRef,
                ...
                $scope.accountgridOptions = {
                    ...
                    angularCompileRows: true,
                    rowClass: function (row) { return ' accountGridRow'; }
                };

                //activityRiskGrid Section
                var activityRiskGridcolumnDefs = [
                  { headerName: "Item ID", width: 540 * globals.defaultVars.w / globals.defaultVars.winRef, field: "id", suppressMenu: true, suppressSorting: true },
                  ...
                  { headerName: "Item ", width: 100 * globals.defaultVars.w / globals.defaultVars.winRef, field: "item", suppressSorting: true },
                  ...
                  { headerName: "Status", width: 100 * globals.defaultVars.w / globals.defaultVars.winRef, field: "status" },
                  { headerName: "Assigned Analyst", width: 300 * globals.defaultVars.w / globals.defaultVars.winRef, field: "assignedAnalyst", suppressMenu: true, suppressSorting: true }
                ];
                ...
                $scope.activityRiskGridOptions = {
                    ...
                    enableSorting: true,
                    angularCompileRows: true,
                    rowClass: function (row) { return ' activityGridRowId activityGridRowId' + row.data.rowId; }
                };
                ...
                var watchListGridColumnDefs = [
                    ...
                    },
                    {
                        ...
                        width: 280 * globals.defaultVars.w / globals.defaultVars.winRef
                    },
                    {
                        headerName: "Ranking",
                        field: "ranking",
                ...
                $scope.watchListGridOptions = {
                    ...
                    rowHeight: 70 * globals.defaultVars.w / globals.defaultVars.winRef,
                    angularCompileRows: true,
                    rowClass: function () { return ' watchlistGridRow'; }
                };
                    ...
                    },
                     {
                         ...
                         cellRenderer: function (params) {
                             ...
                             return '<a style="cursor:pointer!important;" href="' + params.data.url + '"  target="_new">' +
                                 '<span class="clickButton">Related Links</span></a>' + "&nbsp;&nbsp;&nbsp; " + '<a title="Click to Open Negative News Data" class="newsTrigger" ng-click="NegativeNewsDataPopup('
                ...
                $scope.negativeRiskGridOptions = {
                    ...
                    enableSorting: true,
                    angularCompileRows: true,
                    rowClass: function (row) { return ' negativeGridRowId negativeGridRowId' + row.data.rowId; }
                };
                ...
                $scope.showNotes = function ($event, notesId) {
                    ...
                    for (var i = 0; i < taskGridArray.length; i++) {
                        ...
                        if (notesId === idVal) {
                            ...
                            jQuery(".showNotes").hide();

                            $scope.openAddPopup($event, 'notes');
                ...
                $scope.addPersona = function () {
                    if ($scope.PersonaForm.$valid) {
                        ...
                        var cardcount = $scope.cardDatas == undefined ? 0 : $scope.cardDatas.length;
                        ...
                        //Appen new card data into main json
                        var newPersonaObject = {};
                        var dataArray = [];
                        dataArray[0] = cardData["name"];
                        newPersonaObject.names = dataArray;

                        newPersonaObject.isNew = cardData["new"];
                        newPersonaObject.isActive = cardData["active"];
                        newPersonaObject.matchScore = cardData["score"];

                        dataArray = [];
                        dataArray[0] = cardData["source"];
                        newPersonaObject.sources = dataArray;

                        dataArray = [];
                        dataArray[0] = cardData["phone"];
                        newPersonaObject.phones = dataArray;

                        dataArray = [];
                        dataArray[0] = cardData["email"];
                        newPersonaObject.emails = dataArray;

                        dataArray = [];
                        dataArray[0] = cardData["address"];
                        newPersonaObject.addresses = dataArray;

                        $scope.dataObject.person.personas.push(newPersonaObject);
                ...
                $scope.CompletedTask = function () {
                    ...
                    var maxOrderValue = $scope.finder(Math.max, $scope.TasksGrid.rowData, function (x) { return x.order; });
                    var minOrderValue = $scope.finder(Math.min, $scope.TasksGrid.rowData, function (x) { return x.order; });
                    var selectedRowArray = $scope.TaskIDArray;
                    var taskGridArray = $scope.TasksGrid.rowData;
                    var sortedarray = taskGridArray.sort($scope.dynamicSort("order"));


                    // var newArrayForTask = [];
                    for (var i = sortedarray.length - 1; i >= 0; i--) {
                        var idVal = sortedarray[i].taskID;
                        var index = selectedRowArray.indexOf(idVal);
                        if (index !== -1) {
                            sortedarray[i].completed = !sortedarray[i].completed;
                        }

                        sortedarray[i].order = sortedarray[i].completed === true ? minOrderValue++ : maxOrderValue--;

                    }

                    taskGridArray = sortedarray;
                ...
                $scope.finder = function (cmp, arr, getter) {
                ...
                function pageLoad() {
                    ...
                    for (i = 0; i < cardcount; i++) {
                        ...
                        $scope.newcardcount = $scope.newcardcount + (data.isNew ? 1 : 0);
                        var finalVal = "";
                    ...
                    //Activity Risk tab
                    if ($scope.entityDetail.cddPersonData !== undefined) {
                        ...
                        angular.forEach(activityData, function (value, key) {
                            ...
                            if (key === 'alerts') {
                                angular.forEach(rowData, function (values) {
                                    this.push({
                                        "id": values.id,
                                        "itemType": values.alertType,
                                        "item": "Alert",
                                        "accountNumber": values.transactions[0].accountNumber,
                                        "closedDate": values.alertDueDate,
                                ...
                                angular.forEach(rowData, function (values) {
                                    this.push({
                                        "id": values.id,
                                        "itemType": values.caseType,
                                        "item": "Case",
                                        "accountNumber": values.transactions[0].accountNumber,
                                        "closedDate": values.caseDueDate,
                        ...
                        $scope.activityRiskGridOptions.rowData = {};
                        $scope.activityRiskGridOptions.api.onNewRows();
                    }
                ...
                $scope.xAxisTickFormatFunction = function () {
                    return function (d) {
                        return d3.time.format('%x ')(new Date(d));  //uncomment for date format %H:%M:%S
                    }
                }
