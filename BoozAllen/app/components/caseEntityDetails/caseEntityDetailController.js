    ...
    angular.module('riskCanvasApp')
        .controller('caseEntityDetailCtrl', [
            ...
            function ($state, $scope, $stateParams, $window, $http, authenticationSvc, shareData, visDataSet, globals) {
                ...
                //function getNameInitials(cellValue, delimiter) {
                //    var data = cellValue.toUpperCase();
                //    var splittedValue = data.split(delimiter);
                //    var finalVal = "";

                //    for (var i = 0; i < splittedValue.length; i++) {
                //        if (i === 2) break;
                //        finalVal += splittedValue[i].trim().substr(0, 1);

                //        if (splittedValue.length === i + 1) break;

                //    }
                //    return "<span>" + finalVal + "</span>" + cellValue;
                //}
                ...
                //function setChangeDirectionIcon(rowData) {
                //    if (rowData.completed === false) {
                //        return '<a class="selectorClass" style="cursor:pointer!important;" ng-click="MoveUpTask(\'' + rowData.taskID + '\', ' + rowData.order
                //            + ')"><i class="fa fa-sort-asc"></i></a>&nbsp;&nbsp;' +
                //            '<a class="selectorClass" style="cursor:pointer!important;" ng-click="MoveDownTask(\'' + rowData.taskID + '\', ' + rowData.order
                ...
                var watchListGridColumnDefs = [
                    {
                        ...
                        field: "names",
                        width: 300 * globals.defaultVars.w / globals.defaultVars.winRef
                        //cellRenderer: function (params) { return getNameInitials(params.value[0], ",") },
                        //cellClass: 'rag-initial',
                        //cellClassRules: {
                        //    'rag-green': function () { return $scope.primaryDatas.score < 33.334 },
                        //    'rag-amber': function () {
                        //        return $scope.primaryDatas.score >= 33.334 && $scope.primaryDatas.score < 66.667;
                        //    },
                        //    'rag-red': function () { return $scope.primaryDatas.score >= 66.667 }
                        //}
                    },
                    {
                ...
                var pepHitsGridColumnDefs = [
                    {
                        ...
                        width: 300 * globals.defaultVars.w / globals.defaultVars.winRef
                        //cellRenderer: function (params) {
                        //    return getNameInitials(params.value, " ");
                        //},
                        //cellClass: 'rag-initial',
                        //cellClassRules: {
                        //    'rag-green': function () { return $scope.primaryDatas.score < 33.334 },
                    ...
                    },
                    {
                        ...
                        cellRenderer: function (params) {
                            return '<a style="cursor:pointer!important;" href="' + params.data.url + '"  target="_new">' +
                                '<span class="clickButton">Related Links</span></a>';
                        }
                    },
                    {
                        headerName: "",
                        ...
                        cellRenderer: function (params) {
                            ...
                            return '<a title="Click to Open Negative News Data" ng-click="NegativeNewsDataPopup('
                ...
                //    field: "",
                //    hide: false,
                //    width: 100 * globals.defaultVars.w / globals.defaultVars.winRef,
                //    cellRenderer: function (params) { return setChangeDirectionIcon(params.data) }

                //},
                      //{ headerName: "", field: "completed", hide: true },
                    {
                        headerName: "",
                        width: 50 * globals.defaultVars.w / globals.defaultVars.winRef,
                ...
                function load() {
                    ...
                    $http.get("../../../sampleJson/personObject.json")
                        .then(function (res) {
                            ...
                            primaryData["risktype"] = res.data.person.riskDNA.riskDnaScore <= 33.33 ? 'LOW RISK'
                                : res.data.person.riskDNA.riskDnaScore > 33.33 && res.data.person.riskDNA.riskDnaScore <= 66.66
                            ...
                            negativeNewsData = bindNegativeData(negativeNewsData, res.data.person.riskDNA);
                            ...
                            rowNodeDetail = {
                                ...
                                group: 'Primary',
                                physics: false,
                                title: res.data.person.personBaseData.firstName
                ...
                $scope.reloadEntityDetail = function (eventDate) {
                    ...
                    $http.get("../../../sampleJson/personObject.json")
                        .then(function (res) {
                            var entityEvents = res.data.history.events;
                ...
                globals.defaultVars.initScroll('.attributeRiskGrid');
